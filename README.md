# tf-atom-iam-openid-connect-provider-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-iam-openid-connect-provider-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-iam-openid-connect-provider-aws/actions/workflows/ci.yml)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-iam-openid-connect-provider-aws)](https://github.com/PlatformStackPulse/tf-atom-iam-openid-connect-provider-aws/releases)
...
Terraform atom: AWS IAM OpenID Connect Provider - creates an OIDC identity provider for keyless auth
...
| <a name="input_url"></a> [url](#input\_url) | URL of the OIDC identity provider (e.g., https://token.actions.githubusercontent.com) | `string` | n/a | yes |
